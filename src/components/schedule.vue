...
<div class="speakers">
    <div class="title">
        <h1 style="margin:auto">The Schedule</h1>
       
        <div class="dash"></div>
        <div class="schedule-cards" style=" background:#292d53; color: grey; font-size: 20px;"><p>what follows, is the schedule for the Events</p></div>
    </div>
